...
<div style="margin:16px;margin-left:0px">
	<img src="../posts/images/pdf2boxart/kernels.png" alt="Averaging and Gaussian 7x7 kernels">
...
<div style="margin:16px;margin-right:0px;float:right">
	<img src="../posts/images/pdf2boxart/comparison.png" alt="Comparison of the word conductor showing the sharper result when downsampling with Gaussian weights">
...
<div style="margin:16px;margin-left:0px;float:left">
	<img src="../posts/images/pdf2boxart/2dto3d.gif" alt="A 2d image can also be visualized as a 3d height map">
	...
	<img src="../posts/images/pdf2boxart/3dto2d.gif" alt="Panning to the top of the image lying along the plane shows a new 2d image from the 3d height map with outlined pixel intensity">
...
<div style="margin:16px;margin-left:0px">
	<img src="../posts/images/pdf2boxart/line_w26.png" alt="Actual top row from the example with a window size of 26">
...
<div style="margin:16px;margin-left:0px">
	<img src="../posts/images/pdf2boxart/spread.jpg" alt="Full box art spread">
